...
def generate_pdf(audit_data, company_name, sector, audit_start_date, audit_end_date, 
    ...
    toc_items = [
        ...
        "10. Special Considerations Analysis"
    ]
    ...
    content.append(Paragraph(
        ...
        f"{'Special considerations have been identified and will be addressed in detail in section 10.' if special_considerations else ''}",
        normal_style
    ))
    content.append(PageBreak())
        ...
        if not company_name:
            ...
            with st.spinner("Generating audit plan..."):
                try:
                    ...
                    8. Special Considerations Analysis
